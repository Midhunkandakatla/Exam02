...
namespace Kandakatla_Exam_02.Controllers
{
    public class InsuranceController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InsuranceID,InsuranceName,InsurancePhoneNumber")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InsuranceID,InsuranceName,InsurancePhoneNumber")] Insurance insurance)
        {
            if (ModelState.IsValid)
            {
